...
export interface SessionHeader {
  ...
  /**
   * Tenant id stamped when a web principal creates the session; used to filter
   * Sessions API access across restarts. Absent on sessions created without tenant auth.
   */
